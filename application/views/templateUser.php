...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="<?=base_url()?>asset/javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
                <a href="<?=base_url()?>asset/javascript:void(0);" class="bars"></a>
                <a class="navbar-brand" href="<?=base_url()?>asset/index.html">ADMINBSB - MATERIAL DESIGN</a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <!-- Call Search -->
                    <li><a href="<?=base_url()?>asset/javascript:void(0);" class="js-search" data-close="true"><i class="material-icons">search</i></a></li>
                    ...
                    <!-- Notifications -->
                    <li class="dropdown">
                        <a href="<?=base_url()?>asset/javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="body">
                                <ul class="menu">
                                    <li>
                                        <a href="<?=base_url()?>asset/javascript:void(0);">
                            ...
                            <li class="footer">
                                <a href="<?=base_url()?>asset/javascript:void(0);">View All Notifications</a>
                            </li>
                        </ul>
                    </li>
                    <!-- #END# Notifications -->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer">
                                <a href="<?=base_url()?>asset/javascript:void(0);">View All Tasks</a>
                            </li>
                        </ul>
                    </li>
                    <!-- #END# Tasks -->
                    <li class="pull-right"><a href="<?=base_url()?>asset/javascript:void(0);" class="js-right-sidebar" data-close="true"><i class="material-icons">more_vert</i></a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?=base_url()?>asset/images/user.png" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?=base_url()?>asset/javascript:void(0);"><i class="material-icons">person</i>Profile</a></li>
                            <li role="seperator" class="divider"></li>
                            <li><a href="<?=base_url()?>asset/javascript:void(0);"><i class="material-icons">group</i>Followers</a></li>
                            <li><a href="<?=base_url()?>asset/javascript:void(0);"><i class="material-icons">shopping_cart</i>Sales</a></li>
                            <li><a href="<?=base_url()?>asset/javascript:void(0);"><i class="material-icons">favorite</i>Likes</a></li>
                            <li role="seperator" class="divider"></li>
                            <li><a href="<?=base_url()?>asset/javascript:void(0);"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                    <a href="<?=base_url('index.php/logout/logoutUser')?>">
    ...
    function load_total_cart() {
        $.getJSON("<?=base_url()?>index.php/transaksi/showCartItems",function(data){
